const scenes = [
  `<h3 class="demo-title">Find. Scan. Add.</h3><p class="demo-sub">Point your camera at a barcode</p><div class="scanner"><div class="demo-product">EVERYDAY PICKS<strong>OATS</strong><div class="barcode"></div></div><span class="scan-line"></span></div><div class="demo-toast"><b>✓</b> Rolled oats added to your basket</div><p class="demo-note">Illustrative app preview</p>`,
  `<h3 class="demo-title">Your good finds.</h3><p class="demo-sub">Review your basket before paying</p><div class="basket-item"><span>Rolled oats × 1</span><b>₹180</b></div><div class="basket-item"><span>Fresh oranges × 1</span><b>₹90</b></div><div class="basket-item"><span>Oat drink × 1</span><b>₹130</b></div><div class="demo-total"><span>Total</span><span>₹400</span></div><div class="demo-pay">Pay online ↗</div><div class="demo-cash">Or pay cash at the counter</div><p class="demo-note">Illustrative products and prices</p>`,
  `<div class="success"><div class="success-mark">✓</div><h3 class="demo-title">All set. Let's go.</h3><p class="demo-sub">Payment complete</p><div class="qr-illustration" aria-hidden="true"></div><p class="demo-note">Show your exit QR to store staff<br>for verification.</p><div class="demo-toast">A little more time for you. ↗</div><p class="demo-note">Illustration only · not a valid exit QR</p></div>`
];
